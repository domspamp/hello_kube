        ...
        stage ('Deploy') {
            ...
            steps {
                sshagent(credentials: ['cloudlab']) {
                    ...
                    sh 'scp -r -v -o StrictHostKeyChecking=no *.yml DS946528@128.105.146.159:~/'
                    sh 'ssh -o StrictHostKeyChecking=no DS946528@128.105.146.159 kubectl apply -f /users/lngo/deployment.yml -n jenkins'
                    sh 'ssh -o StrictHostKeyChecking=no DS946528@128.105.146.159 kubectl apply -f /users/lngo/service.yml -n jenkins'                                        
                }
            }
        }
    }
